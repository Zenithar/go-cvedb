...
var AdvisoryAPIClientCommand = &cobra.Command{
	Use: "advisoryAPI",
}

var advisoryAPI_SearchClientCommand = &cobra.Command{
	Use:  "search",
...
Authenticate using the Authorization header (requires transport security):
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		grpcClient := NewAdvisoryAPIClient(conn)
...
func init() {
	AdvisoryAPIClientCommand.AddCommand(advisoryAPI_SearchClientCommand)
	DefaultClientCommandConfig.AddFlags(advisoryAPI_SearchClientCommand.Flags())
}
